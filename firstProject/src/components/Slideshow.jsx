            ...
            <div className=' py-32 px-8 flex max-w-7xl mx-auto items-center gap-2'>
                <div className='flex-1 text-xl'>
                    ...
                    <div className='flex gap-4 items-center text-base'>
                        <button type='button' className='inline-flex items-center gap-2 py-3 cursor-pointer px-8 font-medium hover:bg-gray-100 rounded-xl bg-white text-blue-600'>Shop Now <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5" data-fg-eh6d13="1.18:1.3238:/src/app/components/Hero.tsx:29:19:1319:34:e:ArrowRight::::::B1Xc"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></button>
                        <button type='button' className='font-medium hover:bg-white hover:text-blue-600 py-3 cursor-pointer px-8 rounded-xl border-2 border-white'>Learn More</button>
                    </div>
                    <div className='mt-12 '>
                ...
                <div className='flex-1'>
                    <a href="">
                        <img className='w-full h-auto rounded-lg shadow-2xl transform hover:scale-105 transition-transform duration-300' src={slide1} alt="" />
                    </a>
                </div>
            </div>
        </section>
